...
$(function () {
  ...
  var $authControl = $('#authApp-control')
  ...
  // Authentication: none
  $authControl.find("[data-authApp='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[data-authApp]").closest('li').removeClass('active')
    $authControl.find("[data-authApp='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[data-authApp]").closest('li').removeClass('active')
    $authControl.find("[data-authApp='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[data-authApp]").closest('li').removeClass('active')
    $authControl.find("[data-authApp='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[data-authApp]").closest('li').removeClass('active')
    $authControl.find("[data-authApp='session']").closest('li').addClass('active')
